  ...
  get_all_share_notifications = $.ajax({
    ...
    success: function (response) {
      $.each(response, function(i, item){
        ...
        $totalNotifications= $totalNotifications+item.count;
      });
    ...
    form_s3.fileupload({  
      ...
      add: function (event, data) {
        ...
        if (direct_upload_s3_data[0]['progress_bar_ele']) {
          $(direct_upload_s3_data[0]['progress_bar_ele']).append('<div class="single-post-loading"><div style="width: 0;" onclick="close_preview_general_s3(this);" id="' + uid + '" class="s3_running_process edit-load-process ' + uid + '"><span class="small-del"><img src="' + baseurl + '/images/ic_highlight_remove.svg' + '"></span><div class="progress small"><div class="progress-bar" role="progressbar" aria-valuenow="" aria-valuemin="0" aria-valuemax="" style="width:100%"><span class="sr-only"></span></div></div><span class="close"></div></div>');
        }
      },
...
function poplateProfileImage(){
  $('.lazy-asset').each(function(){
    if(!$(this).attr('data-lazy-asset')) return true;
