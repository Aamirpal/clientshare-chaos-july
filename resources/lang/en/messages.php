...
return [
    'api'=> [
        'error' => [
        'google_url_shortener' => 'Error - please try again'
    ]],
    'error'=>[
        'video_thumbnail' => 'Issue while creating video thumbnail for post alert',
        'domain_restriction' => 'User could not be added due to domain restrictions',
        'already_member' => 'This user is already a member of this Client Share',
        'already_pending' => 'This user already has a pending invite for this Client Share. You can resend the invitation via Pending Invites in Settings',
    ...
    'mail_subject' => [
        'analytics_report' => config('constants.APPLICATION.display_name').' Analytics Data',
    ...
    'validation' => [
        ...
        'pin_post_quota' => 'Pin post quota full',
        'uuid_format' => 'Invalid format'
    ],
    'weekly_status' => [
