                        ...
                        <tr>
                           <td style="padding-left: 5px;">
                              <table>
                                 <tr>
                                    <td valign="middle">
                                       <img width="48" height="48" alt="image"  src="{{composeEmailURL($mail_data['share']['seller_processed_logo'])??composeEmailURL($mail_data['share']['company_seller_logo'])}}" style="width:48px;vertical-align:super; height:48px; float:left !important; margin-top:0 !important;"/>
                                    </td>
            ...
            <tr>
               <td align="left" colspan="2" bgcolor="#ffffff" style="background-color: #ffffff; padding: 0px; border-radius: 0 0 6px 6px; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.16);">
                  <table cellspacing="0" style="font-family: arial; font-size: 15px ;color: #424242; line-height: 24px; width: 100%;font-family: arial;">
                     <tr>
                        <td style="padding: 30px 65px 10px;">Hello {{$mail_data['sender']['first_name']}},</td>
                     </tr>
                     <tr>
                        <td style="padding: 10px 65px;">{{ $mail_data['user']['first_name']}} {{ $mail_data['user']['last_name']}} has accepted your invitation to join the {{ $mail_data['share']['share_name'] }} Client Share. <br/></td>
                     </tr>
                     <tr>
                        <td style="padding: 10px 65px;">To view your community <a href="{{ $mail_data['space_link'] }}" style="color: #0d47a1;">click here</a> </td>
                     </tr>
                     <tr>
                        <td style="padding: 10px 65px 30px;">Thanks, <br/>The {{ $mail_data['share']['share_name'] }} Client Share</td>
                     </tr>
                     <tr>
                        <td colspan="2"  style="padding-top: 10px; padding-bottom: 30px; font-family: arial; color: #A4A4A4;font-size: 13px;line-height: 16px;text-align: center;"><font color="#a4a4a4">To unsubscribe from this alert <a href="{{ $mail_data['unsubscribe_share'] }}" style="color: #A4A4A4;">click here</a> to manage your notification settings</font></td>
                     </tr>
                  </table>
               </td>
            </tr>
