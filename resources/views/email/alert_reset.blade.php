                  ...
                  <table style="font-family:arial;font-size:21px;color:#FFFFFF;border-radius:6px 6px 0 0;font-weight:500;display:inline-block;border-collapse:collapse;" cellspacing="0" cellpadding="0" border="0" bgcolor="#424242">
					...
					<tr>
                      <td style="padding-left: 5px;">
                        <img alt="image"  src="{{ $data['path'] }}/images/ic_clientShare1.png">
                      </td>
                      <td style="padding-left:15px;">
                        <span>The {{ $data['mail']['shareid'] }} Client Share</span>
                      </td>
                    </tr>
					<tr><td colspan="2" ><img alt="image"  src="{{ $data['path'] }}/images/email-bg.jpg"></td></tr>
                  </tbody></table>
	...
	<td align="left" colspan="2" bgcolor="#ffffff" style="background-color: #ffffff; padding: 0px; border-radius: 0 0 6px 6px; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.16);">
		<table cellspacing="0" style="font-family: arial; font-size: 15px ;color: #424242; line-height: 24px; width: 100%;font-family: arial;">
			  <tr>
				...
				<td style="padding: 30px 65px 10px;">Hello <?php $fullname  = $data['added_by'];
        ...
        <tr>
				<td style="padding: 20px 65px; text-align: center;"><a href="#!" style="background: #356CCD;border-radius: 3px;color: #fff;font-size: 14px;font-weight: 600;padding: 12px 42px;text-decoration: none;">Reset Password</a><br/></td>
			  </tr>


			   <tr>
				<td style="padding: 10px 65px;">If you did not request a password reset, then please contact <a href="mailto:support@myclientshare.com">support@myclientshare.com</a>.</td>
			   </tr>
			   <tr>
