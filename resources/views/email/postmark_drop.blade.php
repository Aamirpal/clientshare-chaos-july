            ...
            <tr>
               <td align="left" colspan="2" bgcolor="#ffffff" style="background-color: #ffffff; padding: 0px; border-radius: 0 0 6px 6px; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.16);">
                  <table cellspacing="0" style="font-family: arial; font-size: 15px ;color: #424242; line-height: 24px; width: 100%;font-family: arial; padding-bottom: 14px;padding-top: 14px;">
                     <tr>
                        <td style="padding: 10px 65px 10px;">A message to {{ $data['Email'] }} couldn't be delivered:-  </td>
                     </tr>
                     
                     <tr>
                        <td style="padding: 10px 65px 10px;"><b>Subject:</b> {{ str_replace("- get", "", $data['Subject']) }}</td>
                     </tr>
                     <tr>                        
                        <td style="padding: 10px 65px 10px;"><b>Reason:</b> {{ $data['Description']}}</td>                        
                     </tr>
                     <tr>
                        <td style="padding: 10px 65px 10px;"><b>Description:</b> {{ $data['Details'] }}</td>
                     </tr>
                     <tr>
                        <td style="padding: 10px 65px 10px;"><b>Date:</b> {{ Carbon\Carbon::parse($data['BouncedAt'])->timezone($data['timezone']??'Europe/London')->format('d-F-Y h:i')}}</td>
                     </tr>
