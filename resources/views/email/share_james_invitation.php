...
<tr>
	<td colspan="2" align="left" bgcolor="#ffffff" style="background-color: #ffffff; padding: 0px; border-radius: 0 0 6px 6px; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.16);">
		<table cellspacing="0" style="font-family: arial; font-size: 15px ;color: #424242; line-height: 24px; width: 100%;font-family: arial;">
			  ...
			  <tr>
				<td style="padding: 10px 65px;">Welcome to Client Share.</td>
			  </tr>
			   <tr>
				<td style="padding: 10px 65px;">We believe B2B relationships should be better, and brought from<br/> analogue into the digital age.</td>
			   </tr>
			   <tr>
			   <td style="padding: 10px 65px;">Our Client Share purpose is simple: to improve business results and<br/> supplier performance by strengthening and deepening account relationships.</td>
			   </tr>
			   <tr>
			   <td style="padding: 10px 65px;">You’re now part of a growing network of client / supplier relationships.</td></tr>
			   <tr><td style="padding: 10px 65px;">We’d love to talk if you want to know more.</td>
			   </tr>
			   <tr>
				<td style="padding: 10px 65px 30px;">Best <br/>The Client Share Team.</td>
			   </tr>
