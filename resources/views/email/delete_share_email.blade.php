	...
	<tr>
        <td colspan="2" align="center" style="background-color: #424242; border-radius:6px 6px 0 0;">
                  <table style="font-family:arial;font-size:21px;color:#FFFFFF;border-radius:6px 6px 0 0;font-weight:500;display:inline-block;border-collapse:collapse;" cellspacing="0" cellpadding="0" border="0" bgcolor="#424242">
                    <tbody>
					<tr><td colspan="2"><img alt="image"  src="{{ $data['path'] }}/images/email-bg.jpg" ></td></tr>
					<tr>
                      <td style="padding-left: 5px;">
						<table>
                          <tr>
                          <td valign="middle">
                            <img width="48" height="48" alt="image" src="{{composeEmailURL($data['seller_logo'])}}" style="width:48px;vertical-align:super; height:48px; float: left; border-radius: 50px; margin-top:0"/>
                          </td>                           
                          <td valign="bottom">
                          	<img width="58" height="58" alt="image"  src="{{composeEmailURL($data['buyer_logo'])}}" style="width:58px;height:58px; border-radius: 50px; " />
                          </td>
                          </tr>
                        </table>
   ...
   <tr>
	<td colspan="2" align="left" bgcolor="#ffffff" style="background-color: #ffffff; padding: 0px; border-radius: 0 0 6px 6px; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.16);">
		<table cellspacing="0" style="font-family: arial; font-size: 15px ;color: #424242; line-height: 24px; width: 100%;font-family: arial;">
			  ...
			  <tr>
				<td style="padding: 10px 65px;">The {{$data['share_name']}} Client Share has been cancelled. You will no longer be able to access this Client Share. All data within this Client Share will be held for 90 days and then securely deleted.</td>
			  </tr>
			   <tr>
				<td style="padding: 10px 65px;">Please contact
                    <a href="mailto:support@myclientshare.com" style="text-decoration: none;">support@myclientshare.com</a> for further information.</td>
			   </tr>
			   <tr>
				<td style="padding: 10px 65px 30px;">Thanks, <br/>The Client Share Team</td>
			   </tr>
	...
	<td align="center" style="padding: 0px;" colspan="2">
		...
		<tr>
			<td align="center" style="padding: 0 46px; color:#9E9E9E; line-height: 19px; padding-bottom: 16px;">Copyright &copy; 2018 Client Share, All rights reserved.<br/> @include('email.office_address')</td>
		</tr>
