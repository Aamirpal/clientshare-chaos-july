                                                ...
                                                <table cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td  style="padding:0px 60px 0px 15px; text-align: left;">
                                                            <p class="profile-heading" style="margin: 0px;">{{ $mail_data['current_user']['username'] }} has tagged you in the <span style="color: #0D47A1;"><a style="text-decoration:none; color: #0D47A1;" href="{{ $mail_data['space_url'] }}">{!! $mail_data['space']['share_name'] !!}</a></span> Share
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </table>
                                    ...
                                    <table bgcolor="#ffffff" style="border-radius: 0px 0px 10px 10px; font-size: 14px; color: #293248; line-height: 24px; font-family: 'Roboto', sans-serif;display:block;border-collapse:collapse; box-sizing: border-box;" cellspacing="0" cellpadding="0">
                                        <tr>
                                            ...
                                            <td width="480" align="left" bgcolor="#ffffff" style="background-color: #ffffff; padding: 0px; border-radius: 0 0 10px 10px;">
                                                                        ...
                                                                        <table align="center" height="32" width="32" style="width: 32px !important; border-radius: 50px; text-align: center;" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0">
                                                                            <tr>
                                                                                <td height="32" width="32" style="height: 32px; width: 32px;">
                                                                                    <img alt="User Profile Image" height= "32" width= "32" src="{{$people}}" style="border-radius: 50px; height: 32px; width: 32px; vertical-align: middle;"/>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                        </td>
                                                ...
                                                <tr>
                                                    <td style="padding: 10px 0px 0px;font-weight: 500;"><span class="reacted-col">...have also reacted on this post</span></td>
                                                </tr>
                                                @endif
                                                <tr>
                                                    <td style="padding: 60px 0px;">
                                                        <a href="{{ $mail_data['spaceUserlink'] }}"><img alt="Respond" width="85" src="{{ $mail_data['path'] }}/images/respond.png" style="width: 85px;"></a> 
                                                    </td>
                                                </tr>
                                                </table>
                                            </td>
