                        ...
                        <tr>
                           <td style="padding-left: 5px;">
                              <table>
                                 <tr>
                                    <td valign="middle">
                                       <img width="48" height="48" alt="image"  src="{{ $mail_data['path'] }}/images/ic_clientShare1.png" style="width:48px;vertical-align:super; height:48px; float: left; margin-top: 0"/>
                                    </td>
                                 </tr>
                              </table>
                           </td>
            ...
            <tr>
               <td align="left" colspan="2" bgcolor="#ffffff" style="background-color: #ffffff; padding: 0px; border-radius: 0 0 6px 6px; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.16);">
                  <table cellspacing="0" style="font-family: arial; font-size: 15px ;color: #424242; line-height: 24px; width: 100%;font-family: arial;">
                     ...
                     <tr>
                        <td style="padding: 10px 65px;">You requested to download your Client Share Management Information data in xls format. Click the link below to download your data.<br/></td>
                     </tr>
                     <tr>
                        <td style="padding: 20px 65px; text-align: center;"><a href="{{env('APP_URL')}}{{$mail_data['file_path']}}" style="display: inline-block;"><img style="display: inline-block;" src="{{ $mail_data['path'] }}/images/download_btn.png" height="40" alt="Download link"></a><br/></td>
                     </tr>
                     <tr>
                        <td style="padding: 10px 65px 30px;">Regards,<br/>The Client Share</td>
                     </tr>
                  </table>
               </td>
            </tr>
