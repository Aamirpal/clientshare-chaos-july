...
<html xmlns="https://www.w3.org/1999/xhtml">
   ...
   <body style="font-family: arial; background-color: #fff ; margin: 0; background-position: center top; background-repeat: repeat-x; margin: 0; ">
      <div style="font-family: arial; background-color: #fff ; margin: 0; background-image: url('{{ $mail_data['path'] }}/images/white-bg.png'); background-position: center top; background-repeat: repeat-x; margin: 0; ">



         <table width="680" style="font-family: arial; font-size:15px; max-width: 680px !important; margin: 0 auto;  border-radius:6px 6px 0 0;" cellspacing="0" cellpadding="0" align="center">
            <tbody>
               <tr>
                                               ...
                                               <tbody>
                                                 <tr>
                                                   <td valign="top" style="background-color:#fff;color:#8192AA;   border: 1px solid #E0E0E0;height:162px;width:234px;">
                                                     <table cellspacing="0" cellpadding="0" border="0" style="width:100%">
                                                       <tr>
                                                         <td valign="top" style="padding:17px 17px 0 17px; height:16px;color:#8192AA;font-size:16px;font-weight:600;line-height:16px;text-align:center;">Customer Community</td>
                                                       </tr>
                                                       <tr>
                                                   ...
                                                   <td valign="top" style="background-color:#fff;color:#8192AA;   border: 1px solid #E0E0E0; height:162px;width:234px;">
                                                     <table cellspacing="0" cellpadding="0" border="0" style="width:100%">
                                                       <tr>
                                                         <td valign="top" style="padding:17px 17px 0 17px; height:16px;color:#8192AA;font-size:16px;font-weight:600;line-height:16px;text-align:center;">Supplier Community</td>
                                                       </tr>
                                                       <tr>
                                                 ...
                                                 <tr>
                                                   <td valign="top" style="background-color:#fff;color:#8192AA;   border: 1px solid #E0E0E0;height:162px;width:234px;">
                                                     <table cellspacing="0" cellpadding="0" border="0" style="width:100%">
                                                       <tr>
                                                         <td valign="top" style="padding:17px 17px 0 17px; height:16px;color:#8192AA;font-size:16px;font-weight:600;line-height:16px;text-align:center;">Posts This Month</td>
                                                       </tr>
                                                       <tr>
                                                   ...
                                                   <td valign="top" style="background-color:#fff;color:#8192AA;   border: 1px solid #E0E0E0;height:162px;width:234px;">
                                                     <table cellspacing="0" cellpadding="0" border="0" style="width:100%">
                                                       <tr>
                                                         <td valign="top" style="padding:17px 17px 0 17px; height:16px;color:#8192AA;font-size:16px;font-weight:600;line-height:16px;text-align:center;">Client Share Index (CSI)</td>
                                                       </tr>
                                                       <tr>
