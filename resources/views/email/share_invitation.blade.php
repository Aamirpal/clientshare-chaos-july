					...
					<tr>
                      <td style="padding-left: 5px;">
						<table>
                          <tr>
                          <td valign="middle">
                            <img width="48" height="48" alt="image"  src="{{composeEmailURL($data['company_seller_logo'])}}" style="width:48px;vertical-align:super; height:48px; float: left; margin-top:0; border-radius: 50px;"/>
                          </td>                           
                          <td valign="bottom"><img width="58" height="58" alt="image"  src="{{composeEmailURL($data['company_buyer_logo'])}}" style="width:58px;height:58px; border-radius: 50px;" />
                          </td>
                          </tr>
                        </table>
                      ...
                      <td  style="padding-left:15px;">
                        The&nbsp;<?php echo str_replace(' ','&nbsp;',$data->share_name); ?><br>Client Share
                      </td>
                    </tr>
					<tr><td colspan="2"><img alt="image"  src="{{ $data['path'] }}/images/email-bg.jpg"></td></tr>
                  </tbody></table>
   ...
   <tr>
	<td colspan="2" align="left" bgcolor="#ffffff" style="background-color: #ffffff; padding: 0px; border-radius: 0 0 6px 6px; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.16);">
		<table cellspacing="0" style="font-family: arial; font-size: 15px ;color: #424242; line-height: 24px; width: 100%;font-family: arial;">
			  ...
			  <tr>
				<td style="padding: 10px 65px;">You have been invited to become the administrator of the {{ $data->share_name }} Client Share.</td>
			  </tr>
			   <tr>
				<td style="padding: 10px 65px;"><a href="{{ $data->link }}" style="color: #0d47a1;">Please click here to create your Client Share.</a></td>
			   </tr>
			   <tr>
