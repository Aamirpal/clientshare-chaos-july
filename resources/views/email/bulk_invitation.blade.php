            ...
            <tr>
               <td align="left" colspan="2" bgcolor="#ffffff" style="background-color: #ffffff; padding: 0px; border-radius: 0 0 6px 6px; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.16);">
                  <table cellspacing="0" style="font-family: arial; font-size: 15px ;color: #424242; line-height: 24px; width: 100%;font-family: arial;">
                     ...
                     <tr>
                        <td style="padding: 10px 65px;">You requested to bulk generate invite URLs. Click the link below to export the Invite URLs.<br/></td>
                     </tr>
                     <tr>
                        <td style="padding: 20px 65px; text-align: center;"><a href="{{composeEmailUrl($mail_data['file_path'])}}" style="display: inline-block;"><img style="display: inline-block;" src="{{ $mail_data['path'] }}/images/download-invite-btn.png" height="40" alt="Download Invite URLs"></a><br/></td>
                     </tr>
                     <tr>
                        <td style="padding: 10px 65px;">If you did not request to generate your {{ $mail_data['share']['share_name'] }} Client Share Bulk Invite URLs then please contact <a href="mailto:{{config('constants.email.support_email')}}">{{config('constants.email.support_email')}}</a>.</td>
                     </tr>
                     <tr>
